...
/* 
PublicApiService Waiting List
Subscribe a user to the waiting list, &#x60;name&#x60; is not required.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *V1PublicWaitingListPostOpts - Optional Parameters:
     * @param "Body" (optional.Interface of PublicWaitingListRequest) - 

@return DefaultResponse
*/

type V1PublicWaitingListPostOpts struct { 
	Body optional.Interface
}

func (a *PublicApiService) V1PublicWaitingListPost(ctx context.Context, localVarOptionals *V1PublicWaitingListPostOpts) (DefaultResponse, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/v1/public/waiting-list"
	...
	if localVarOptionals != nil && localVarOptionals.Body.IsSet() {
		...
		localVarOptionalBody, localVarOptionalBodyok := localVarOptionals.Body.Value().(PublicWaitingListRequest)
		if !localVarOptionalBodyok {
				return localVarReturnValue, nil, reportError("body should be PublicWaitingListRequest")
		}
